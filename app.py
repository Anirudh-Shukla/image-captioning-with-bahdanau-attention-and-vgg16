...
def extract_features(image):
    ...
    vgg_model = tf.keras.Model(inputs=vgg_model.input, outputs=vgg_model.layers[-1].output)
    features = vgg_model.predict(image_array, verbose=0)
    features = tf.keras.layers.Flatten()(features)
    features = tf.keras.layers.Dense(4096, activation='relu')(features)
    return features

# Streamlit app
st.title("Visionary Narratives")
